...
#     set(LEMON_FILES "${${var}} ${CMAKE_CURRENT_BINARY_DIR}/${DST}.c ${CMAKE_CURRENT_BINARY_DIR}/${DST}.cpp ${CMAKE_CURRENT_BINARY_DIR}/${DST}.h")
#     message(STATUS ${LEMON_FILES})

#     ADD_CUSTOM_COMMAND(
#         OUTPUT ${LEMON_FILES}
#         COMMAND cmake -E ${COPY_OR_LINK} ${CMAKE_CURRENT_SOURCE_DIR}/${SRC}.y ${CMAKE_CURRENT_BINARY_DIR}/${DST}.y
#         COMMAND cmake -E chdir ${CMAKE_CURRENT_BINARY_DIR} lemon -smp ${DST}.y
#         COMMAND cmake -E ${COPY_OR_LINK} ${CMAKE_CURRENT_BINARY_DIR}/${DST}.c ${CMAKE_CURRENT_BINARY_DIR}/${DST}.cpp
#         MAIN_DEPENDENCY ${CMAKE_CURRENT_SOURCE_DIR}/${SRC}.y
#     )
#     message(STATUS "${CMAKE_CURRENT_SOURCE_DIR}/${SRC}.y")
# endmacro(LEMON)
